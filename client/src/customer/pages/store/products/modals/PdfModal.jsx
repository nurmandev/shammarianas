...
// Functional component for the PdfModal
const PdfModal = () => {
  ...
  return (
    // Main container for the PdfModal
    <div className="h-fit">
      {/* Container for PDF preview with lock overlay */}
      <span className="relative h-80 w-full">
        {/* Displaying PDF preview image */}
        <img
          src={`${import.meta.env.VITE_SERVER_URL}/uploads/${
            productData.product_files[0]
          }`}
          alt={productData.product_name}
          className="h-96 min-w-full object-cover object-center hover:opacity-75 duration-200"
        />
        {/* Lock overlay on top of the PDF preview */}
        <img
          src="/shapes/lock.png"
          alt="lock"
...
// Exporting the PdfModal component as the default export
