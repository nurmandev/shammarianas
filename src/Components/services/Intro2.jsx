...
function Intro2() {
  ...
  return (
    <section className="section-padding sub-bg bord-top-grd bord-bottom-grd intro-accord mt-20 mb-20">
          ...
          <div className="col-lg-6 valign">
            <div>
              <div className="sec-head mb-50 mt-50">
                <h6 className="sub-title main-color mb-50">Why choose us?</h6>
                <h3>
